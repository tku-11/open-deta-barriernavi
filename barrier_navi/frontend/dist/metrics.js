...
export const METRICS_BY_MODE = {
    body: BODY_METRICS,
    hearing: HEARING_METRICS,
    vision: VISION_METRICS,
};
export const PREFERRED_FEATURE_TO_METRIC_KEY = {
    'エレベーター': {
        body: ['elevator_ratio'],
        hearing: [],
...
export function metricKeysForPreferredFeature(feature, mode) {
    return PREFERRED_FEATURE_TO_METRIC_KEY[feature]?.[mode] ?? [];
}
